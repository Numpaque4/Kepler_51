...
def photoRingPosterior():
    ...
    hfuncs=interp1d(xms,hms,kind='cubic')
    ...
    fig.savefig("figures/scatter-PR-TransitDepth-test.png")
...
S.p=analyticalTransitArea(S.Rp,S.block,
                          S.fi,S.fe,
                          S.ieff)/pi
rho_obs=rhoObserved_Seager(S.p,S.Rstar,tT,tF,S.Porb/HOUR)
print(rho_true,rho_obs)
